...
G_DEFINE_TYPE (GrdSettingsSystem,
               grd_settings_system,
               GRD_TYPE_SETTINGS)

GrdSettingsSystem *
grd_settings_system_new ()
{
  GrdSettingsSystem *settings_system =
    g_object_new (GRD_TYPE_SETTINGS_SYSTEM,
...
init_file_monitor ()
{
  ...
  file_monitor = g_file_monitor (g_file,
                                 G_FILE_MONITOR_NONE,
                                 NULL,
                                 &error);
  if (!file_monitor)
